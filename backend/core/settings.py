"""
Django settings for AI System Template project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-template-secret-key-prod-2026')
...
HERMES_REQUEST_TIMEOUT = int(os.getenv('HERMES_REQUEST_TIMEOUT', '120'))
